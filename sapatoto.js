(function() {
    ...
    const sapatotoThemeStyles = `
        ...
        #custom-sidebar-toggle:hover{background:linear-gradient(45deg,#ec4899,#be185d)!important;box-shadow:0 0 15px rgba(236, 72, 153, 0.8)!important;transform:scale(1.05)!important}
    ...
    async function injectGacorGame() { 
        ...
        try {
            ...
            displayGacorGames(t,[fallback].slice(0,a));
        }
    }
