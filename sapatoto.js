(function() {
    // BLOK CSS LENGKAP TEMA SAPATOTO (NEON PINK & PURPLE)
    const sapatotoThemeStyles = `
        @import url("https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css");
        .input-group-text { background-color: #2c3e50; border-color: #34495e; color: #f472b6; }
        ...
        #nav-tab .nav-link.active { color: #fff !important; background-color: #1a252f !important; border-color: #ec4899 !important; border-radius: 8px 8px 0 0 !important; }
        #nav-tabContent { background-color: #1a252f; border: 1px solid #ec4899; border-top: none; padding: 2rem !important; color: #ecf0f1; border-radius: 0 0 8px 8px; }
        #nav-tabContent h3 { color: #a855f7 !important; }
        #betting-page-container .card { background: linear-gradient(145deg, #2c3e50, #1a252f) !important; border: 1px solid #ec4899 !important; box-shadow: 0 0 20px rgba(236, 72, 153, .6) !important; border-radius: 15px !important; color: #ecf0f1; }
        #betting-page-container .card-header { background-color: rgba(236, 72, 153, .1); border-bottom: 1px solid #ec4899; color: #a855f7; font-weight: bold; text-transform: uppercase; font-size: 1.1rem; padding: .75rem 1.25rem; }
        ...
        #betting-page-container .category-buttons .btn, #betting-page-container .bet-type-toggle .btn { border-color: #ec4899 !important; color: #f472b6 !important; background-color: transparent !important; text-transform: none !important; font-weight: normal; }
        #betting-page-container .category-buttons .btn:hover, #betting-page-container .bet-type-toggle .btn:hover { background-color: rgba(236, 72, 153, .2) !important; color: #fff !important; }
        #betting-page-container .category-buttons .btn.active, #betting-page-container .btn-check:checked + .btn { background: linear-gradient(45deg, #be185d, #ec4899) !important; border-color: #ec4899 !important; color: #fff !important; font-weight: bold; box-shadow: 0 0 15px #ec4899; }
        #betting-page-container .table-input { background-color: rgba(0,0,0,0.15); }
        #betting-page-container .table-input thead th { background-color: rgba(236, 72, 153, .1) !important; border-bottom: 2px solid #ec4899 !important; color: #ecf0f1; }
        #betting-page-container .form-check-input { background-color: #1a252f; border-color: #34495e; }
        #betting-page-container .form-check-input:checked { background-color: #f472b6; border-color: #f472b6; box-shadow: 0 0 10px #f472b6; }
        ...
        #betting-page-container .table-input td.td-input .form-control:focus { box-shadow: inset 0 0 0 2px #f472b6 !important; }
        ...
        #profile-page-container .profile-label i { margin-right: 12px; color: #f472b6; font-size: 1.2em; }
        ...
        #confirmModal #invoice-content tfoot { background-color: rgba(236, 72, 153, .1) !important; color: #ecf0f1 !important; }
        ...
        #confirmModal .modal-footer .btn-danger {
            ...
            border: none !important;
            color: #fff !important;
            box-shadow: 0 0 10px #ec4899, inset 0 0 5px rgba(255,255,255,.4) !important;
        }
