(function() {
    ...
    function styleMemberStatusPanel() { 
        ...
        if (greetingDiv) { 
            ...
            if (usernameStrong) { 
                ...
                greetingDiv.appendChild(usernameStrong); 
                greetingDiv.style.lineHeight = '1.2em'; 
            } 
        } 
