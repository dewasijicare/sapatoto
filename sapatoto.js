(function() {
    ...
    function styleRegisterPage() {
        ...
        if (!document.getElementById(styleId)) {
            ...
            style.id = styleId;
            style.innerHTML = `
                .has-validation-error .invalid-feedback { display: block !important; color: #ff4444 !important; font-size: 0.8em; margin-top: 4px; text-align: left; font-weight: normal; }
                .form-control.is-invalid { border-color: #ff4444 !important; background-image: none !important; box-shadow: none !important; }
        ...
        Object.keys(fieldConfig).forEach(id => {
            ...
            if (!inputGroup) {
                ...
                inputGroup.className = 'input-group mb-0'; 
                const iconSpan = document.createElement('span');
                iconSpan.className = 'input-group-text';
