(function() {
    // =========================================
    // BAGIAN 1: CSS TAMPILAN KEREN (REVISI)
    // =========================================
    const togelGridStyles = `
        /* --- 1. Kustomisasi Container Utama (FIX OVERLAP) --- */
        #carousel-togel .owl-stage-outer {
            max-height: 520px; 
            overflow: hidden !important; /* DIKEMBALIKAN KE HIDDEN AGAR TIDAK TUMPAH KE BAWAH */
            transition: max-height 0.5s ease-in-out;
            border-radius: 0 0 8px 8px;
            padding: 5px; /* Memberi sedikit ruang untuk shadow di dalam */
        }
        ...
        /* Tombol Show More (FIX POSISI & MARGIN) */
        .show-more-wrapper { 
            display: flex; justify-content: center; 
            margin-top: 15px; 
            margin-bottom: 25px; /* Mendorong banner di bawahnya */
        ...
        /* Grid Setup */
        #carousel-togel .owl-stage { display:grid!important; grid-template-columns:repeat(auto-fit,minmax(145px,1fr)); gap:15px; transform:none!important; width:100%!important; margin-top: 5px; }
        #carousel-togel .owl-item { width:auto!important; margin-right:0!important }

        /* --- 2. Desain BOX Keren (Glassmorphism) --- */
        ...
        #carousel-togel .card:hover::after {
            left: 150%; transition: all 0.7s ease-in-out;
        }
        ...
        /* --- 4. Tipografi & Detail (REVISI UKURAN & KETERBACAAN) --- */
        /* Nama Pasaran (Diperkecil ke 0.75em) */
        #carousel-togel .card-body > .text-center > div:first-child, .row.g-3 .card-body > .text-center > div:first-child {
            color: #bdc3c7; font-size: 0.75em !important; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600; display: flex; align-items: center; justify-content: center;
        }
        ...
        /* Angka Result */
        #carousel-togel .card h2, .row.g-3 .card h2 { background: 0 0 !important; margin: 10px 0 !important; font-size: 2.2em !important; font-weight: 700; }
        ...
        /* Timer Countdown & Peringatan (DIHAPUS EFEK NEONNYA, DIGANTI SHADOW GELAP) */
        ...
        .togel-countdown-timer.show-warning-text::before { 
            ...
            text-shadow: 0px 1px 3px rgba(0,0,0,0.8); /* Shadow hitam agar kontras */
            font-weight: 700; white-space: nowrap; font-size: 0.75rem; display: flex; align-items: center; justify-content: center; transform: translateY(-2px); 
        }
